...
16:30-19:15 22 pages! (many removed, but with graphics changes)
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Chapter~RT Java (removed)
       \item Some text from Chapter~RT Java into the embedded
           section of Chapter~\ref{chap:java}, Intro from it
           as part of the history section
