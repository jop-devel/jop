...
Count: 90.5h 31.5. Low-level I/O chapter, HWO

31.5. 14 new hwo pages in 2.5 hours.
...
\begin{itemize}
  ...
  \end{itemize}
    ...
    \item A section on I/O organization (scio moduels) and I/O
        top level into JOP Hardware Architecture.
    \item Low-level I/O access
    \begin{itemize}
      \item First JHAL text + removed text
      \item I/O examples
      \item At the end legacy Native stuff
    \end{itemize}
