...
//
// On Wed Mar 10 17:33:15 CET 2010
//
...
module mkNoC3bs2(CLK,
  ...
  wire [7 : 0] MUX_noc_routers_0_node_rcvCnt$write_1__VAL_2,
	       MUX_noc_routers_0_node_sndCnt$write_1__VAL_2,
	       MUX_noc_routers_1_node_rcvCnt$write_1__VAL_2,
	       MUX_noc_routers_1_node_sndCnt$write_1__VAL_2,
	       MUX_noc_routers_2_node_rcvCnt$write_1__VAL_2,
  ...
  wire MUX_noc_coms$write_1__SEL_2,
       ...
       MUX_noc_routers_0_node_rcvMore$write_1__SEL_1,
       MUX_noc_routers_0_res$write_1__SEL_1,
       MUX_noc_routers_1_cnt$write_1__SEL_1,
       MUX_noc_routers_1_node_rcvMore$write_1__SEL_1,
       MUX_noc_routers_1_res$write_1__SEL_1,
       MUX_noc_routers_2_cnt$write_1__SEL_1,
       MUX_noc_routers_2_node_rcvMore$write_1__SEL_1,
       MUX_noc_routers_2_res$write_1__SEL_1;

  // remaining internal signals
  wire [15 : 0] x__h2811, x__h5424, x__h8029;
  wire [7 : 0] statusByte__h2784,
	       statusByte__h5397,
	       statusByte__h8002,
	       x__h1334,
	       x__h3959,
	       x__h6564;
  wire noc_routers_0_node_slot_73_EQ_0_77_AND_noc_rou_ETC___d316,
       noc_routers_1_node_slot_65_EQ_1_69_AND_noc_rou_ETC___d208,
       noc_routers_2_node_slot_6_EQ_2_0_AND_noc_route_ETC___d100;
  ...
  assign WILL_FIRE_RL_noc_routers_0_node_detectSndStart =
	     noc_routers_0_node_sndFIFO$EMPTY_N &&
	     noc_routers_0_node_slot_73_EQ_0_77_AND_noc_rou_ETC___d316 ;
  ...
  assign MUX_noc_routers_0_node_rcvMore$write_1__SEL_1 =
	     WILL_FIRE_RL_noc_routers_0_node_detectRcvStart &&
	     noc_coms[33:32] == 2'd1 ;
  ...
  assign MUX_noc_routers_1_node_rcvMore$write_1__SEL_1 =
	     WILL_FIRE_RL_noc_routers_1_node_detectRcvStart &&
  ...
  assign MUX_noc_routers_2_node_rcvMore$write_1__SEL_1 =
	     WILL_FIRE_RL_noc_routers_2_node_detectRcvStart &&
  ...
  // register noc_routers_0_node_rcvCnt
  always@(WILL_FIRE_RL_noc_routers_0_node_continueRcv or
	  x__h1334 or
	  WILL_FIRE_RL_noc_routers_0_waitRcvData or
	  MUX_noc_routers_0_node_rcvCnt$write_1__VAL_2 or
	  WILL_FIRE_RL_noc_routers_0_node_detectRcvStart)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_noc_routers_0_node_continueRcv:
	  noc_routers_0_node_rcvCnt$D_IN = x__h1334;
      WILL_FIRE_RL_noc_routers_0_waitRcvData:
	  noc_routers_0_node_rcvCnt$D_IN =
	      MUX_noc_routers_0_node_rcvCnt$write_1__VAL_2;
      WILL_FIRE_RL_noc_routers_0_node_detectRcvStart:
  ...
  // register noc_routers_1_node_rcvCnt
  always@(WILL_FIRE_RL_noc_routers_1_node_continueRcv or
	  x__h3959 or
	  WILL_FIRE_RL_noc_routers_1_waitRcvData or
	  MUX_noc_routers_1_node_rcvCnt$write_1__VAL_2 or
	  WILL_FIRE_RL_noc_routers_1_node_detectRcvStart)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_noc_routers_1_node_continueRcv:
	  noc_routers_1_node_rcvCnt$D_IN = x__h3959;
      WILL_FIRE_RL_noc_routers_1_waitRcvData:
  ...
  // register noc_routers_2_node_rcvCnt
  always@(WILL_FIRE_RL_noc_routers_2_node_continueRcv or
	  x__h6564 or
	  WILL_FIRE_RL_noc_routers_2_waitRcvData or
	  MUX_noc_routers_2_node_rcvCnt$write_1__VAL_2 or
	  WILL_FIRE_RL_noc_routers_2_node_detectRcvStart)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_noc_routers_2_node_continueRcv:
	  noc_routers_2_node_rcvCnt$D_IN = x__h6564;
      WILL_FIRE_RL_noc_routers_2_waitRcvData:
  ...
  assign noc_routers_0_node_rcvFIFO$DEQ =
	     WILL_FIRE_RL_noc_routers_0_waitRcvData ;
  assign noc_routers_0_node_rcvFIFO$CLR = 1'b0 ;
  ...
  assign noc_routers_1_node_rcvFIFO$CLR = 1'b0 ;
  ...
  assign noc_routers_2_node_rcvFIFO$CLR = 1'b0 ;
  ...
  // remaining internal signals
  assign noc_routers_0_node_slot_73_EQ_0_77_AND_noc_rou_ETC___d316 =
	     noc_routers_0_node_slot == 2'd0 && noc_routers_0_node_sending &&
	     (noc_routers_0_node_firstWord || noc_coms[33:32] == 2'd2) &&
	     noc_routers_0_node_sndCnt != 8'd0 ;
  assign noc_routers_1_node_slot_65_EQ_1_69_AND_noc_rou_ETC___d208 =
	     noc_routers_1_node_slot == 2'd1 && noc_routers_1_node_sending &&
	     (noc_routers_1_node_firstWord || noc_coms_1[33:32] == 2'd2) &&
	     noc_routers_1_node_sndCnt != 8'd0 ;
  assign noc_routers_2_node_slot_6_EQ_2_0_AND_noc_route_ETC___d100 =
	     noc_routers_2_node_slot == 2'd2 && noc_routers_2_node_sending &&
	     (noc_routers_2_node_firstWord || noc_coms_2[33:32] == 2'd2) &&
	     noc_routers_2_node_sndCnt != 8'd0 ;
  assign statusByte__h2784 =
	     { !noc_routers_0_node_rcvFIFO$FULL_N,
	       !noc_routers_0_node_rcvFIFO$EMPTY_N,
	       !noc_routers_0_node_sndFIFO$FULL_N,
	       !noc_routers_0_node_sndFIFO$EMPTY_N,
  ...
  assign x__h1334 = noc_routers_0_node_rcvCnt + 8'd1 ;
  assign x__h2811 = { statusByte__h2784, 8'd0 } ;
  assign x__h3959 = noc_routers_1_node_rcvCnt + 8'd1 ;
  assign x__h5424 = { statusByte__h5397, 8'd1 } ;
  assign x__h6564 = noc_routers_2_node_rcvCnt + 8'd1 ;
  assign x__h8029 = { statusByte__h8002, 8'd2 } ;
