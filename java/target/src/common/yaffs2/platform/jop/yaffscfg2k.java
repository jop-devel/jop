...
//		#endif
	...
	public int yaffs_StartUp()
	{
		...
		device.subField1.writeChunkToNAND = InternalNANDYaffs1NANDInterface.instance;
		device.subField1.readChunkFromNAND = InternalNANDYaffs1NANDInterface.instance;
		device.subField1.eraseBlockInNAND = InternalNANDYaffs1NANDInterface.instance;
		device.subField1.initialiseNAND = InternalNANDYaffs1NANDInterface.instance;
