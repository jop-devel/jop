...
public class yaffscfg2k implements yaffs2.port.yaffscfg2k_C
{
	/*
...
//		#endif
	...
	public int yaffs_StartUp()
	{
		...
		bootDev.subField1.writeChunkToNAND = InternalNANDYaffs1NANDInterface.instance;
		bootDev.subField1.readChunkFromNAND = InternalNANDYaffs1NANDInterface.instance;
		bootDev.subField1.eraseBlockInNAND = InternalNANDYaffs1NANDInterface.instance;
		bootDev.subField1.initialiseNAND = InternalNANDYaffs1NANDInterface.instance;
