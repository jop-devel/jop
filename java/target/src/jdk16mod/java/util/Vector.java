...
//     }
     ...
     * be {@code minCapacity}.</p>
     *
     * @param minCapacity the desired minimum capacity
     *
     * <p>bh: patched variant, which always increases the capacity to 
     *    minCapacity if minCapacity is greater than oldCapacity.</p>
     */
    ...
    private void ensureCapacityHelper(int minCapacity) {
        int oldCapacity = elementData.length;
        if (minCapacity > oldCapacity) {
	    throw new Error("Automatic capacity adjustments"+
			    " are not allowed in this RT version"+
			    " of the JDK");
        }
    }
