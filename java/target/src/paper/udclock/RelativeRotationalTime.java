 ...
 *
 */
public class RelativeRotationalTime extends RotationalTime implements RelativeAbstractTime {

	public RelativeRotationalTime(long rotations, int degrees, Clock clock) {
