...
public interface DataInput {
    /**
     * Reads some bytes from an input stream and stores them into 
     * the buffer array <code>b</code>. The number of bytes read 
     * is equal to the length of <code>b</code>.
     * <p>
     * This method blocks until one of the following conditions 
     * occurs:<p>
     * <ul>
     * <li><code>b.length</code> bytes of input data are available, 
     * in which case a normal return is made.
     *
