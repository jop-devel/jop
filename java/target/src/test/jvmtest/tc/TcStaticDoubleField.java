...
public class TcStaticDoubleField extends TestCase {
	...
	/**
	 * Field to test getfield/putfield instruction on double fields
	 */
	private static double AField;
