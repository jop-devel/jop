...
public class QuadHelper {
    ...
    public static StackStatement createLoad(VariableStmt stmt, int var) {
        return new StackLoad(stmt.getUsedTypes()[var], stmt.getUsedVars()[var]);
    }

    public static StackStatement createStore(AssignStmt stmt) {
        return new StackStore(stmt.getAssignedType(), stmt.getAssignedVar());
    }
}
