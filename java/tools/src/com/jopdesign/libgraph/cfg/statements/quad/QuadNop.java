...
import com.jopdesign.libgraph.cfg.statements.stack.StackNop;
 ...
 */
public class QuadNop extends NopStmt implements QuadStatement {

    public QuadNop() {
    }

    public StackStatement[] getStackCode(VariableTable varTable) {
        return new StackStatement[] { new StackNop() };
    }
