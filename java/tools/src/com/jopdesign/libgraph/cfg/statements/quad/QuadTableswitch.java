...
import com.jopdesign.libgraph.cfg.statements.stack.StackTableswitch;
 ...
 */
public class QuadTableswitch extends TableswitchStmt implements QuadStatement, VariableStmt {

    private Variable key;

    public QuadTableswitch(int lowValue, int highValue, Variable key) {
        super(lowValue, highValue);
        this.key = key;
    }

    public String getCodeLine() {
        return "tableswitch " + key.getName() + ":\n" + getTable();
    }
    ...
    public StackStatement[] getStackCode(VariableTable varTable) {
        return new StackStatement[] {
                ...
                new StackTableswitch(getLowValue(), getHighValue())
        };
    }
