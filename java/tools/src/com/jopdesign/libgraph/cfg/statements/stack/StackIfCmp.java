...
import com.jopdesign.libgraph.cfg.statements.quad.QuadIfCmp;
 ...
 */
public class StackIfCmp extends IfStmt implements StackStatement {

    public StackIfCmp(TypeInfo type, int operand) {
