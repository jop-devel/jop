...
import com.jopdesign.libgraph.cfg.statements.quad.QuadInstanceof;
 ...
 */
public class StackInstanceof extends InstanceofStmt implements StackStatement, StackAssign {

    public StackInstanceof(ConstantClass constantClass) {
        super(constantClass);
    }
