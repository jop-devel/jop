 ...
 */
public class StackParamAssign extends ParamAssignStmt implements StackStatement, AssignStmt {

    public StackParamAssign(TypeInfo type, Variable param, int paramNr) {
        super(type, param, paramNr);
    }
