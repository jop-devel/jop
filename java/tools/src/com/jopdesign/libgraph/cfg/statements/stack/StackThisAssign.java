 ...
 */
public class StackThisAssign extends ThisAssignStmt implements StackStatement, AssignStmt {

    public StackThisAssign(ConstantClass thisClass, Variable thisVar) {
        super(thisClass, thisVar);
    }
