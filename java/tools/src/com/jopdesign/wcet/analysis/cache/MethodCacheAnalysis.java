...
public class MethodCacheAnalysis {
	...
	public void analyzeBlockUsage() {
		...
		while(iter.hasNext()) {
			...
			IPETSolver ipetSolver = GlobalAnalysis.buildIpetProblem(key, sg, ipetConfig);
			IPETBuilder<SuperGraph.CallContext> ipetBuilder = new IPETBuilder<SuperGraph.CallContext>(null);
