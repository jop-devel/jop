 ...
 */
public class GraphPrinter extends AbstractMethodAction {
    ...
    public boolean configure(String prefix, JopConfig config) throws ConfigurationException {
        ...
        format = config.getOption(prefix + CONF_FORMAT, "txt");
        outfile = config.getOption(prefix + CONF_OUTFILE, format.equals("txt") ? "-" :
