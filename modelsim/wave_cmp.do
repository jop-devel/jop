...
add wave -noupdate -format Literal /tb_jop/cmp_jop/gen_cpu__1/cmp_cpu/cmp_core/cmp_fch/pc
add wave -noupdate -divider core2
add wave -noupdate -format Literal /tb_jop/cmp_jop/gen_cpu__2/cmp_cpu/cmp_core/cmp_fch/pc
...
WaveRestoreCursors {{Cursor 1} {9447891442 ps} 0}
...
update
WaveRestoreZoom {9447363783 ps} {9457213421 ps}
