...
rem make -e QPROJ=altde2-70cmp BLASTER_TYPE=USB-Blaster COM_PORT=COM6 P1=bench P2=jembench P3=Main

rem make japp -e USB=true QPROJ=cyccsp P1=paper P2=csp P3=BenchCsp COM_PORT=COM4

make japp -e USB=true QPROJ=usbmin P1=bench P2=fixed P3=LoopAes COM_PORT=COM4
