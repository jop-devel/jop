...
add wave -noupdate -format Literal /tb_fpu/fpout_y
...
add wave -noupdate -format Logic /tb_fpu/ine_y
add wave -noupdate -format Logic /tb_fpu/overflow_o
add wave -noupdate -format Logic /tb_fpu/overflow_y
add wave -noupdate -format Logic /tb_fpu/underflow_o
add wave -noupdate -format Logic /tb_fpu/underflow_y
add wave -noupdate -format Logic /tb_fpu/div_zero_o
add wave -noupdate -format Logic /tb_fpu/div_by_zero_y
add wave -noupdate -format Logic /tb_fpu/inf_o
add wave -noupdate -format Logic /tb_fpu/inf_y
add wave -noupdate -format Logic /tb_fpu/zero_o
add wave -noupdate -format Logic /tb_fpu/zero_y
add wave -noupdate -format Logic /tb_fpu/qnan_o
add wave -noupdate -format Logic /tb_fpu/qnan_y
add wave -noupdate -format Logic /tb_fpu/snan_o
add wave -noupdate -format Logic /tb_fpu/snan_y
